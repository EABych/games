...
import { SecretAgentGame } from './components/secret-agent/SecretAgentGame';
import { SecretAgentPlayer } from './components/secret-agent/SecretAgentPlayer';
...
import './components/secret-agent/SecretAgent.css';
...
const MainApp: React.FC = () => {
  ...
  const getCurrentGameFromPath = useCallback((): 'home' | 'alias' | 'fants' | 'krocodil' | 'this-or-that' | 'poet' | 'yersh' | 'mafia' | 'spy' | 'headwords' | 'evening-role' | 'adult-fants' | 'secret-agent' => {
    ...
    if (path === '/secret-agent') return 'secret-agent';
    return 'home';
  }, [location.pathname]);

  const [appPhase, setAppPhase] = useState<'home' | 'alias' | 'fants' | 'krocodil' | 'this-or-that' | 'poet' | 'yersh' | 'mafia' | 'spy' | 'headwords' | 'evening-role' | 'adult-fants' | 'secret-agent'>(getCurrentGameFromPath());
    ...
    <div className="app">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/player/evening-role/:roomId" element={<EveningRolePlayer />} />
          <Route path="/player/secret-agent/:roomId" element={<SecretAgentPlayer />} />
